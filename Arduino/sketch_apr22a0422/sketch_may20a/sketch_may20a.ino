...
const char* ssid     = "geeklab";
const char* password = "ai@geeklab";
...
void setup()
{
    ...
    pinMode(14, OUTPUT);      // set the controlLED pin mode
      ...
      if (client.available()) {             // if there's bytes to read from the client,
        ...
        if (c == '\n') {                    // if the byte is a newline character
          ...
          if (currentLine.length() == 0) {
            ...
            client.print("Click <a href=\"/HH\">here</a> to turn the LED on pin 4 on.<br>");
            client.print("Click <a href=\"/LL\">here</a> to turn the LED on pin 4 off.<br>");
        ...
        if (currentLine.endsWith("GET /HH") {
          digitalWrite(14, HIGH);                // GET /L turns the LED off
        }
