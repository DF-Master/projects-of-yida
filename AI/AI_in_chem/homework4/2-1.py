...
tsne(dim=2)
vistualization(x_tsne_2, c=kmeans_after_tsne.labels_, name='euclidean')
tsne(metric=tanimoto_similarity, dim=2)
vistualization(x_tsne_2,
               c=kmeans_after_tsne.labels_,
               name='tanimoto_similarity')
tsne(metric=cosine_similarity, dim=2)
vistualization(x_tsne_2, c=kmeans_after_tsne.labels_, name='cosine_similarity')
tsne(metric=dice_similarity, dim=2)
vistualization(x_tsne_2, c=kmeans_after_tsne.labels_, name='dice_similarit')
